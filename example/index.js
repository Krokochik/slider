...
for (let i = 0; i < 25; i++) {
    carousel.addElement(Object.assign(document.createElement("a"), {
        innerHTML: `<img src="https://picsum.photos/seed/${i+1}/150">`,
        href: `https://picsum.photos/seed/${i+1}/150`,
        target: "_blank",
        className: "carousel-item"
    }));
}
carousel.elementWidth = "calc((100vw - 200px) / 5)"
carousel.render();
...
for (let i = 0; i < 12; i++) {
    presentation.addElement(Object.assign(document.createElement("div"), {
        className: "container",
        innerHTML: `
            <div class="presentation-item" style="background-image: url('https://picsum.photos/seed/${Math.pow(i+2, 10)}/1024')">
